...
public:
	...
	//@cmember allow attaching of a new CSECEdit
	void SECEditCtrl::AttachEdit(SECEdit* pEdit);
  SECEdit* DetachEdit();
...
protected:
	...
	//@cmember Showing that this Object has created the edit
	BOOL m_mySECEdit;
