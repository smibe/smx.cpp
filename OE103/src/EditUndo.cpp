...
BOOL SECEdit::UndoEdit()
   ...
   switch (pUndoRecord->iUndoType)
	...
	//////////////////////////////////////////
      ...
      case OE_UNDO_UNFOLD:
        FoldLines(GoToLineNo(pUndoRecord->iRow), GoToLineNo(pUndoRecord->iEndRow), pUndoRecord->lpBuffer);
  			break;
