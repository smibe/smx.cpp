...
//------------------------------------------------------------------------------
//
// $Header: D:\\CVSRoot/FCU/src/LIST.cxx,v 1.1 2002/09/20 09:34:47 GeH Exp $
//
********************************************************************************/
 ...
 { HANDLE hMem;
   ...
   { if (pBlock->iInUse<0)
     { 
        ...
        TCHAR szBuf[512];
        LoadString(NULL, IDS_LIST_ALLOC_NEGATIVE, szBuf, sizeof(szBuf));
...
LIST APIENTRY List_Create(void)
  {  LIST lst;
     ...
     lst = (struct item_tag *) Alloc(iAnchorSize);
